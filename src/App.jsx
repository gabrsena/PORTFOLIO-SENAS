    ...
    >
      ...
      <div className="relative z-10 flex justify-center items-start pt-4">
        <div className="relative px-4 py-2">
          <div className="text-[#F2F2F2]/40 group-hover:text-[#F2F2F2] transition-colors duration-500 transform group-hover:scale-110">
            {service.icon}
          </div>
        </div>
      </div>
  ...
  return (
    <div className="bg-[#0D0D0D] text-[#F2F2F2] font-sans selection:bg-[#B91C1C] selection:text-white overflow-x-hidden w-full perspective-[1000px]">
      ...
      <motion.nav 
        ...
        className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center py-4 px-8 h-[calc(3.54rem+2rem)] lg:h-[calc(4.33rem+2rem)]"
      >
