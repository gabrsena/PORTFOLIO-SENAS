    ...
    <div className="bg-[#0D0D0D] text-[#F2F2F2] font-sans selection:bg-[#B91C1C] selection:text-white overflow-x-hidden w-full">
                  ...
                  >
                    {projects.map((project, index) => (
                      <div 
                        ...
                        className="mx-4 md:mx-6 h-[50vh] md:h-[65vh] aspect-[9/16] relative bg-[#161616] overflow-hidden shadow-2xl cursor-pointer group"
                      ...
                      >
                         ...
                         <div className="absolute inset-0 flex flex-col justify-end p-6 bg-gradient-to-t from-black/90 via-black/40 to-transparent opacity-100">
                            <h3 className="text-2xl md:text-3xl font-anton uppercase mb-1 text-[#F2F2F2] drop-shadow-lg opacity-60 group-hover:opacity-100 transition-opacity duration-300">
                              {project.title}
                            </h3>
                             <div className="mt-4 overflow-hidden">
                                <span className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-[#B91C1C] opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
        ...
        <div className="max-w-4xl w-full flex flex-col items-center text-center gap-12">
            ...
            <RevealOnScroll delay={0.4}>
              <div className="flex flex-wrap justify-center gap-8 mt-8">
                 <a href="mailto:gabrsena@hotmail.com" className="p-4 rounded-full border border-[#F2F2F2]/10 hover:border-[#B91C1C] hover:bg-[#B91C1C]/10 text-[#F2F2F2] hover:text-[#B91C1C] transition-all duration-300">
                   <Mail size={28} />
                 </a>
                 <a href="https://www.linkedin.com/in/gabrielsenas/" target="_blank" rel="noopener noreferrer" className="p-4 rounded-full border border-[#F2F2F2]/10 hover:border-[#B91C1C] hover:bg-[#B91C1C]/10 text-[#F2F2F2] hover:text-[#B91C1C] transition-all duration-300">
                   <Linkedin size={28} />
                 </a>
                 <a href="https://wa.me/5511973759325" target="_blank" rel="noopener noreferrer" className="p-4 rounded-full border border-[#F2F2F2]/10 hover:border-[#B91C1C] hover:bg-[#B91C1C]/10 text-[#F2F2F2] hover:text-[#B91C1C] transition-all duration-300">
                   <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                      <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.231-.298.347-.497.117-.199.06-.372-.03-.497-.09-.124-.817-1.969-1.118-2.697-.291-.706-.576-.613-.793-.613h-.67c-.224 0-.594.083-.906.417-.311.334-1.186 1.159-1.186 2.828 0 1.668 1.215 3.28 1.385 3.511.17.231 2.392 3.653 5.795 5.122 1.956.844 2.716.837 3.684.737.967-.1 3.12-1.275 3.557-2.506.437-1.231.437-2.285.306-2.506-.13-.223-.475-.35-.772-.5z" />
                      <path fillRule="evenodd" clipRule="evenodd" d="M12 0C5.373 0 0 5.373 0 12c0 2.122.555 4.168 1.59 6.01L.5 23.5l5.638-1.035C8.01 23.55 10.02 24 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818c-1.785 0-3.535-.468-5.075-1.355l-.364-.21-3.765.69 1.003-3.665-.236-.375C2.696 15.35 2.182 13.722 2.182 12c0-5.415 4.405-9.818 9.818-9.818 5.414 0 9.818 4.403 9.818 9.818 0 5.414-4.404 9.818-9.818 9.818z" fillOpacity="0.2"/>
                   </svg>
                 </a>
              </div>
            </RevealOnScroll>
      ...
      <AnimatePresence>
        {showAbout && (
          ...
          >
             <button onClick={() => setShowAbout(false)} className="fixed top-8 right-8 z-[110] text-[#F2F2F2] hover:text-[#B91C1C] transition-colors">
                <X size={40} />
             </button>
            <div className="min-h-screen flex items-center justify-center py-20 px-8">
               <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="flex flex-col gap-8 items-center md:items-start">
                  ...
                  <motion.div className="w-[50%] md:w-[50%]" initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.4 }}>
                    <div className="relative w-full aspect-[3/4] overflow-hidden grayscale hover:grayscale-0 transition-all duration-700 ease-in-out group mx-auto">
                        <img src="https://i.imgur.com/ovtRA8O.jpeg" alt="Gabriel Sena" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" loading="lazy" />
